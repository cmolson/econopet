...
module mock_sram #(
    ...
    always @(data_io) begin
        ...
        // Track the last value driven while WE is low. The WB->RAM bridge
        // drops its data OE on the same edge WE rises, and a real SRAM has
        // tDH = 0 -- sampling data_io at the posedge reads a released bus
        // under Verilator's evaluation order.
